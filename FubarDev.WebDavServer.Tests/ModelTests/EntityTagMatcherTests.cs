...
namespace FubarDev.WebDavServer.Tests.ModelTests
{
    public class EntityTagMatcherTests
    {
        ...
        public void IfMatchStrongTest()
        {
            ...
            Assert.Equal(1, _entityTags.Count(x => matcher.IsMatch(x)));
        }
        ...
        public void IfMatchNoneTest()
        {
            ...
            Assert.Equal(0, _entityTags.Count(x => matcher.IsMatch(x)));
        }
        ...
        public void IfNoneMatchStrongTest()
        {
            ...
            Assert.Equal(2, _entityTags.Count(x => matcher.IsMatch(x)));
        }
        ...
        public void IfNoneMatchNoneTest()
        {
            ...
            Assert.Equal(3, _entityTags.Count(x => matcher.IsMatch(x)));
        }
    }
}
