...
namespace FubarDev.WebDavServer.Locking
{
    ...
    public class LockEventArgs : EventArgs
    {
        ...
        /// </summary>
        /// <param name="activeLock">The lock that got added to or removed from the lock manager.</param>
        ...
        /// <summary>
        /// Gets the lock that got added to or removed from the lock manager.
        /// </summary>
